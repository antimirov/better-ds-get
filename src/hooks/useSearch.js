...
export const SearchProvider = ({ children }) => {
    ...
    const fetchResults = useCallback(async (tid) => {
        ...
        try {
            // Fetch more results at once to improve per-engine counting accuracy and bypass pagination limits
            const data = await downloadStation.btSearchList(tid, 0, 300);
